/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config config/wrangler.json` (hash: 4eb152292f1391afa655a2acbb837fbc)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		APP_URL: "https://hono-boilerplate.a3s.workers.dev" | "https://hono-boilerplate-staging.a3s.workers.dev";
